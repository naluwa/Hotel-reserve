  ...
  (
    ...
    return (
      ...
      >
        <div
          ref={ref || modalRef}
          className={`w-full ${sizes[size]} overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/95 shadow-modal ring-1 ring-white/5 focus:outline-none ${className}`}
          role="dialog"
          aria-modal="true"
