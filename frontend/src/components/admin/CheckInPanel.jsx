...
export default function CheckInPanel({ token, showToast, onRoomsChanged }) {
        ...
        <div className="mb-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">
              ...
              the room will be marked{" "}
              <strong className="text-white">Occupied</strong>.
            </p>
          </div>
                  ...
                  <tr>
                    <td colSpan={8} className="p-6 text-center text-slate-500">
                      ...
                      <span className="text-xs">
                        Reservations with status &ldquo;Reserved&rdquo; will
                        appear here.
                      </span>
                    </td>
                  </tr>
