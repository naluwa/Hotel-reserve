          ...
          >
            <div className="flex flex-col gap-1">
              <Input
                ...
                onChange={(e) => setNewAdminForm({ email: e.target.value })}
              />
              <p className="text-[11px] text-slate-400 mt-1">
                System will register this email as an eligible administrator.
                The new admin will create their password upon their first login
                setup.
              </p>
            </div>
