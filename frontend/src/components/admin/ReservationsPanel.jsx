...
const RESERVATION_STATUS_OPTIONS = ["Reserved", "Checked In", "Checked Out"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (form.reservationId) {
        await updateReservation(form.reservationId, payload, token);
        ...
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">
              ...
              details.
              {form.reservationId
                ? " Edit status or payment status before saving."
                : ""}
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
          ...
          {form.reservationId && (
            <Select
              ...
              options={RESERVATION_STATUS_OPTIONS.map((status) => ({
                value: status,
                label: status,
              }))}
            ...
            <div className="md:col-span-2 flex flex-col gap-4 rounded-[1.25rem] border border-cashmere-700 bg-heritage-900 p-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-white">
                  {calculatedDetails.nights} Nights × LKR{" "}
                  {calculatedDetails.pricePerNight} per night
                </p>
              </div>
          ...
          <div className="md:col-span-2">
            <Button type="submit" fullWidth>
              {form.reservationId ? "Update Reservation" : "Create Reservation"}
            </Button>
          </div>
        </form>
      </div>
                        ...
                        <td className="p-2 space-y-2">
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                            <button
                              ...
                              className="rounded-3xl bg-blue-600 px-3 py-1.5 text-xs font-bold uppercase text-white transition hover:bg-blue-500"
                            >
                              Edit
                            </button>
                            <button
